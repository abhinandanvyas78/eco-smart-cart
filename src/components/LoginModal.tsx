      ...
      <div className="fixed inset-0 flex items-center justify-center z-50 p-4">
        <div className="bg-white rounded-lg shadow-xl w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-4">
            ...
            {/* Forgot Password */}
            <a href="#" className="text-green-600 hover:underline text-sm font-semibold inline-block">
              Forgot Password?
            </a>
            ...
            <div className="space-y-2">
              <button
                type="button"
                className="w-full border border-gray-300 bg-white text-gray-700 py-2 rounded-lg hover:bg-gray-50 transition font-semibold flex items-center justify-center gap-2"
              >
